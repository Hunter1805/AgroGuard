...
export const ToolsReportView: React.FC = () => {
  const { filters, updateFilters, resetFilters } = useReportFilters();
  const { data, loading } = useReportData('ferramentas', filters);
  ...
  return (
    <div className="space-y-4 text-xs animate-fade-in">
      <ReportHeader
        ...
        subtitle="Disponibilidade, empréstimos atrasados, patrimônio e aferição de calibrações"
      ...
      <div className="glass-card rounded-2xl border border-white/10 overflow-hidden">
        ...
        {loading ? (
          <div className="p-12 text-center text-xs text-on-surface-variant">Carregando relatório de ferramentas...</div>
