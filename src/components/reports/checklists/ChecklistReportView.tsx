...
export const ChecklistReportView: React.FC = () => {
  ...
  return (
    <div className="space-y-4 text-xs animate-fade-in">
      <ReportHeader
        ...
        subtitle="Execuções, taxa de conformidade operacional e apontamento de não conformidades"
        columns={colsToDisplay}
        onToggleColumn={handleToggleColumn}
        onExport={fmt => data && exportData('Relatório de Checklists', 'checklists', fmt, { ...data, columns: colsToDisplay })}
      />
      ...
      <div className="glass-card rounded-2xl border border-white/10 overflow-hidden">
        ...
        {loading ? (
          <div className="p-12 text-center text-xs text-on-surface-variant">Carregando relatório de checklists...</div>
