...
export const StockReportView: React.FC = () => {
  ...
  const { data, loading } = useReportData('pecas-estoque', filters);
  ...
  return (
    <div className="space-y-4 text-xs animate-fade-in">
      <ReportHeader
        ...
        subtitle="Saldos, reservas, valor em estoque, custo médio ponderado e itens sem movimentação"
        columns={colsToDisplay}
        onToggleColumn={handleToggleColumn}
        onExport={fmt => data && exportData('Relatório de Peças e Estoque', 'pecas-estoque', fmt, { ...data, columns: colsToDisplay })}
      />
      ...
      <div className="glass-card rounded-2xl border border-white/10 overflow-hidden">
        ...
        {loading ? (
          <div className="p-12 text-center text-xs text-on-surface-variant">Carregando relatório de estoque...</div>
