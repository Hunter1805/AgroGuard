  ...
  return (
    ...
    >
      <div className="glass-card rounded-xl border border-default p-5 space-y-4">
        <div className="flex justify-between items-start border-b border-default pb-3">
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 text-[12px]">
          <div className="bg-surface-container-highest/40 p-3 rounded-lg border border-default">
          ...
          <div className="bg-surface-container-highest/40 p-3 rounded-lg border border-default font-mono-label">
        ...
        {data.notes && (
          <div className="bg-surface-container-highest/30 p-3 rounded-lg border border-default text-[12px]">
