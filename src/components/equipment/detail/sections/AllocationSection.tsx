...
export const AllocationSection: React.FC<Props> = ({ equipment }) => {
  ...
  return (
    <div className="glass-card rounded-xl p-5 border border-default space-y-3">
      <h4 className="text-[14px] font-semibold text-on-surface flex items-center gap-2 pb-2 border-b border-default">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 text-[12px]">
        {fields.map((f) => (
          <div key={f.label} className="bg-surface-container-highest/30 p-2.5 rounded-lg border border-default">
