    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative z-10 w-full max-w-md bg-surface-container-lowest border-l border-default flex flex-col h-full shadow-2xl overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          <div className="glass-card rounded-xl border border-default p-3 space-y-1 text-[12px]">
        ...
        <div className="p-4 border-t border-default bg-surface-container-high/40 flex justify-end">
          <button onClick={onClose} className="px-4 py-2 rounded-lg bg-surface-container-highest border border-default text-[12px] font-medium text-on-surface">
            Fechar
          </button>
        </div>
      </div>
