...
export const UserDetailView: React.FC<DetailProps> = ({ isOpen, onClose, user }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-2xl bg-surface-container-lowest border border-default rounded-xl p-5 shadow-2xl flex flex-col max-h-[85vh] overflow-hidden space-y-4">
        ...
        <div className="flex-1 overflow-y-auto pr-1 text-[13px] space-y-3">
          {activeTab === 'visao_geral' && (
            <div className="grid grid-cols-2 gap-3">
              <div className="glass-card rounded-xl border border-default p-3 space-y-1">
          ...
          {activeTab === 'perfis' && (
            <div className="glass-card rounded-xl border border-default p-4 space-y-2">
          ...
          {activeTab === 'preferencias' && (
            <div className="glass-card rounded-xl border border-default p-4 space-y-2 text-[12px]">
        ...
        <div className="pt-3 border-t border-default flex justify-end">
          <button onClick={onClose} className="px-4 py-1.5 rounded-lg bg-surface-container-highest border border-default text-[12px] text-on-surface">
            Fechar Ficha
          </button>
        </div>
      </div>
