...
export const RoleForm: React.FC<FormProps> = ({ isOpen, onClose, initialData, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-3xl bg-surface-container-lowest border border-default rounded-xl p-5 shadow-2xl space-y-4 max-h-[90vh] flex flex-col overflow-hidden">
