  ...
  return (
    <div className={`p-4 rounded-2xl transition-all border ${
      isNOK
        ...
        : 'bg-surface-container-highest/70 border-default'
    }`}>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl border font-bold transition-transform active:scale-95 cursor-pointer ${
                  result === 'conforme'
                    ...
                    : 'bg-surface-container hover:bg-surface-container-highest text-on-surface border-default'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl border font-bold transition-transform active:scale-95 cursor-pointer ${
                  result === 'nao_conforme'
                    ...
                    : 'bg-surface-container hover:bg-surface-container-highest text-error border-default'
                }`}
              >
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-xl border font-medium text-[11px] transition-transform active:scale-95 cursor-pointer ${
                    result === 'nao_se_aplica'
                      ...
                      : 'bg-surface-container text-on-surface-variant/70 border-default'
                  }`}
                >
                  N/A
                </button>
        ...
        {item.responseType === 'numero' || item.responseType === 'medicao' ? (
          <div className="max-w-xs">
            ...
            <input
              ...
              className="bg-surface-container border border-default rounded-lg px-3 py-1.5 text-[13px] text-on-surface w-full focus:outline-none focus:border-primary"
        ...
        {item.responseType === 'texto' ? (
          <div>
            <textarea
              ...
              rows={2}
              className="w-full bg-surface-container border border-default rounded-lg p-2 text-[12px] text-on-surface focus:outline-none focus:border-primary"
            />
          </div>
        ) : null}
          ...
          <div className="mt-3 pt-3 border-t border-error/20 space-y-2 animate-fade-in text-[12px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-surface-container border border-default rounded-lg px-3 py-1.5 text-on-surface focus:outline-none"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-surface-container border border-default rounded-lg px-3 py-1.5 text-on-surface text-[12px] focus:outline-none"
              />
            </div>
          </div>
        )}
